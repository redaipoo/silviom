...
export const ShareModal: React.FC<ShareModalProps> = ({ isOpen, onClose, design }) => {
  ...
  const currentUrl = typeof window !== 'undefined'
    ...
    : `https://almagd-kitchens.com/designs/${design.slug}`;
    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <motion.div
          ...
          className="relative w-full max-w-md bg-brand-dark/95 border border-brand-gold/30 rounded-2xl shadow-2xl p-6 z-10 overflow-hidden"
        >
          {/* Header */}
